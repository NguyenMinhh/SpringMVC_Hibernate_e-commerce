<%-- 
    Document   : slider
    Created on : Dec 26, 2016, 9:49:03 PM
    Author     : HoangMinh
--%>
...
<div class="slider-holder">
    <div class="promo">
        <img src="resources/css/images/promo.jpg" alt="Big Sale This Week -30% OFF!" />
    </div>						
    <div id="slider">
        <ul>
            <li>
                <img src="resources/css/images/slide1.jpg" alt="colour pencils" title="" />
                <div class="caption">
            ...
            <li>
                <img src="resources/css/images/slide2.jpg" alt="pencils"  title=""/>
                <div class="caption">
            ...
            <li>
                <img src="resources/css/images/slide1.jpg" alt="pencils" />
                <div class="caption">
                    <h2>Tên sản phẩm 3</h2>
                    <div class="text">
            ...
            <li>
                <img src="resources/css/images/slide2.jpg" alt="pencils" />
                <div class="caption">
