...
public class Pager {
    ...
    public String pageList(int curpage, int pages, String namePage) {
        ...
        if ((curpage - 1) > 0) {
            if ((curpage == 0 || pages != 0)) {
                page_list += " <a class='a1' href=\"" + namePage + "?page=1\" title=\"Trang đầu\"><<</a> ";
            }
            page_list += "<a class='a1' href=\"" + namePage + "?page=" + (curpage - 1) + "\" title=\"Về trang trước\"><</a> ";
        ...
        for (int i = 1; i <= pages; i++) {
            if (i == curpage) {
                ...
                page_list += "<a class='a1' href=\"" + namePage + "?page=" + i + "\" title=\"Trang " + i + "\">" + i + "</a>";
            }
            page_list += " ";
        }
        ...
        if ((curpage + 1) <= pages) {
            page_list += "<a class='a1' href=\"" + namePage + "?page=" + (curpage + 1) + "\" title=\"Đến trang sau\">></a> ";

        }
        if ((curpage != pages) && (pages != 0)) {
            page_list += "<a class='a1' href=\"" + namePage + "?page=" + pages + "\" title=\"Trang cuối\">>></a> ";
        }
        page_list += "\n";
        return page_list;
    }
    ...
    public String pageListQueryString(int curpage, int pages, String namePage, String queryString) {
        ...
        if ((curpage - 1) > 0) {
            if ((curpage == 0 || pages != 0)) {
                page_list += " <a class='a1' href=\"" + namePage + "?page=1" + queryString + "\" title=\"Trang đầu\"><<</a> ";
            }
            page_list += "<a class='a1' href=\"" + namePage + "?page=" + (curpage - 1)+ queryString + "\" title=\"Về trang trước\"><</a> ";
        ...
        for (int i = 1; i <= pages; i++) {
            if (i == curpage) {
                ...
                page_list += "<a class='a1' href=\"" + namePage + "?page=" + i + queryString + "\" title=\"Trang " + i + "\">" + i + "</a>";
            }
            page_list += " ";
        }
        ...
        /* In linh cua trang tiep theo va trang cuoi cung neu can*/
        if ((curpage + 1) <= pages) {
            page_list += "<a class='a1' href=\"" + namePage + "?page=" + (curpage + 1) + queryString + "\" title=\"Đến trang sau\">></a> ";

        }
        if ((curpage != pages) && (pages != 0)) {
            page_list += "<a class='a1' href=\"" + namePage + "?page=" + pages + queryString + "\" title=\"Trang cuối\">>></a> ";
        }
        page_list += "\n";
        return page_list;
    }
